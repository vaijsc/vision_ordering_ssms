#!/bin/bash
#SBATCH --job-name=mv_rep
#SBATCH --error=/home/anhnd81/anhnd81/workspace/mambavision_1/mambavision/result/mambaV_rep.txt
#SBATCH --nodes=1
...
torchrun --master-port=12381 --nproc_per_node=4 $RUN_FILE --mesa ${MESA} --input-size 3 224 224 --crop-pct=0.875 \
