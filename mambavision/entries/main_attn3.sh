#!/bin/bash
#SBATCH --job-name=attn3_mv
#SBATCH --error=/home/anhnd81/anhnd81/workspace/mambavision_1/mambavision/result/mambaV_attn3.txt
#SBATCH --nodes=1
...
BS=128
EXP=Attn3
# EXP=Test # after debug change this  -----------------------------------------------------------
LR=8e-4
WD=0.05
WR_LR=1e-6
DR=0.38
MESA=0.25
# RUN_FILE="/lustre/scratch/client/vinai/users/phinh2/workspace/mambavision_1/mambavision/train_attn1.py"
RUN_FILE="/home/anhnd81/anhnd81/workspace/mambavision_1/mambavision/train_attn3.py"
torchrun --master_port 12355 --nproc_per_node=1 $RUN_FILE --mesa ${MESA} --input-size 3 224 224 --crop-pct=0.875 \
