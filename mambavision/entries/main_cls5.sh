#!/bin/bash
#SBATCH --job-name=mv_cls5
#SBATCH --error=/lustre/scratch/client/vinai/users/ducna22/workspace/mambavision_1/mambavision/result/mambaV_cls5.txt
#SBATCH --nodes=1
...
DR=0.38
MESA=0.25
RUN_FILE="/lustre/scratch/client/vinai/users/ducna22/workspace/mambavision_1/mambavision/train_cls5.py"
torchrun --master_port 12359 --nproc_per_node=1 $RUN_FILE --mesa ${MESA} --input-size 3 224 224 --crop-pct=0.875 \
