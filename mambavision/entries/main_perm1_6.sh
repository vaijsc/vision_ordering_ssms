#!/bin/bash
#SBATCH --job-name=perm6_mv
#SBATCH --error=/lustre/scratch/client/vinai/users/phinh2/workspace/mambavision_1/mambavision/result/mambaV_perm6.txt
#SBATCH --nodes=1
...
# DR=0.2
MESA=0.25
RUN_FILE="/lustre/scratch/client/vinai/users/phinh2/workspace/mambavision_1/mambavision/train_perm1.py"
