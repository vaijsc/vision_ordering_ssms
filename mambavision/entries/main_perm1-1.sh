#!/bin/bash
#SBATCH --job-name=mvp1-1
#SBATCH --error=/home/anhnd81/anhnd81/workspace/mambavision_1/mambavision/result/mambaV_p1-1.txt
#SBATCH --nodes=1
...
RUN_FILE="/home/anhnd81/anhnd81/workspace/mambavision_1/mambavision/train_perm1_1.py"
...
torchrun --master-port=12380 --nproc_per_node=1 $RUN_FILE --mesa ${MESA} --input-size 3 224 224 --crop-pct=0.875 \
