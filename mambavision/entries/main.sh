...
torchrun --master_port 12368 --nproc_per_node=4 $RUN_FILE --mesa ${MESA} --input-size 3 224 224 --crop-pct=0.875 \
 ...
 --resume /lustre/scratch/client/vinai/users/ducna22/workspace/mambavision_1/output/train/original/20240919-091635-mamba_vision_T-224/checkpoint-83.pth.tar \
