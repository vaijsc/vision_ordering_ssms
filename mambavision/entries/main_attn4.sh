#!/bin/bash
#SBATCH --job-name=mv_attn4
#SBATCH --error=/home/anhnd81/anhnd81/workspace/mambavision_1/mambavision/result/mambaV_attn4.txt
#SBATCH --nodes=1
...
RUN_FILE="/home/anhnd81/anhnd81/workspace/mambavision_1/mambavision/train_attn4.py"
