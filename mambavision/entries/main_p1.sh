...
#SBATCH --error=/lustre/scratch/client/vinai/users/phinh2/workspace/mambavision_1/mambavision/result/mambaV_p1.txt
#SBATCH --nodes=1
...
DR=0.2
MESA=0.25
RUN_FILE="/lustre/scratch/client/vinai/users/phinh2/workspace/mambavision_1/mambavision/train_p1.py"
