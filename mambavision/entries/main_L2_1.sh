#!/bin/bash
#SBATCH --job-name=mv_L2_original
#SBATCH --error=/lustre/scratch/client/vinai/users/phinh2/workspace/mambavision_1/mambavision/result/mambaV_L2_original.txt
#SBATCH --nodes=1
...
torchrun --master_port 12367 --nproc_per_node=1 $RUN_FILE --mesa ${MESA} --input-size 3 224 224 --crop-pct=0.875 \
