#!/bin/bash
#SBATCH --job-name=ord2-6
#SBATCH --error=/lustre/scratch/client/vinai/users/phinh2/workspace/mambavision_1/mambavision/result/mambaV_ord2_6.txt
#SBATCH --nodes=1
...
torchrun --master_port 12381 --nproc_per_node=3 $RUN_FILE --mesa ${MESA} --input-size 3 224 224 --crop-pct=0.875 \
