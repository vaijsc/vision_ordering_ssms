#!/bin/bash
#SBATCH --job-name=swap_mv
#SBATCH --error=/lustre/scratch/client/vinai/users/phinh2/workspace/mambavision_1/mambavision/result/mambaV_attn.txt
#SBATCH --nodes=1
...
DR=0.38
MESA=0.25
RUN_FILE="/lustre/scratch/client/vinai/users/phinh2/workspace/mambavision_1/mambavision/train_attn.py"
