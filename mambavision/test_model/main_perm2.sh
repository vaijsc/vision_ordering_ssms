#!/bin/bash
#SBATCH --job-name=mv_perm2
#SBATCH --error=/home/anhnd81/anhnd81/workspace/mambavision_1/mambavision/result/mambaV_perm2.txt
#SBATCH --nodes=1
...
RUN_FILE="/home/anhnd81/anhnd81/workspace/mambavision_1/mambavision/train_perm2.py"
