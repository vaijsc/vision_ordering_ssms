#!/bin/bash
#SBATCH --job-name=attn1_mv
#SBATCH --error=/lustre/scratch/client/vinai/users/phinh2/workspace/mambavision_1/mambavision/result/mambaV_attn1.txt
#SBATCH --nodes=1
...
torchrun --master_port 12353 --nproc_per_node=1 $RUN_FILE --mesa ${MESA} --input-size 3 224 224 --crop-pct=0.875 \
